                    ...
                    <div class="row ml-2">
                            ...
                            <div id="checkBox1" style="display: none">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button id="personal_sub_title_add" type="button" class="btn btn-info">Add Personal Sub Title</button>
                                        <script type="text/javascript">
                                            ...
                                            $(document).on('click', "#add_personal_child_title", function() {
                                                ...
                                                html += '<div id="personal_sub_title_row">';
                                                html += '<lable for=""> Personal Child Title: </lable>';
                                                html += '<div class="input-group mb-3">';
                        ...
                        <div class="col-md-6">
                            <div id="checkBox2" style="display: none">
                                <label for="">Company Main Title :</label>
                                <input type="text" class="form-control mb-3" name="title[]">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="company_sub_title_new"></div>
                                        <button id="company_sub_title_add" type="button" class="btn btn-info">Add Company Sub Title</button>
                                        <script type="text/javascript">
                                            ...
                                            $("#company_sub_title_add").click(function() {
                                                ...
                                                html += '<lable for=""> Company Sub Title: </lable>';
                                                html += '<div class="input-group mb-3">';
                                                html += '<input type="text" name="company_sub_title_'+company_sub_title+'[]" class="form-control m-input"><br>';
                                                html += '<div class="input-group-append">';
                                                html += '<button id="add_company_child_title" type="button" class="btn btn-info">Company Add Child</button>';
                                                html += '</div>';
                                                html += '<div class="input-group-append">';
                                            ...
                                            $(document).on('click', "#add_company_child_title", function() {
                                                ...
                                                html += '<div id="company_sub_title_row">';
                                                html += '<lable for=""> Company Child Title: </lable>';
                                                html += '<div class="input-group mb-3">';
